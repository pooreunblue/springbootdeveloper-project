package me.baekseungho.springbootdeveloper.controller;
...
class BlogApiControllerTest {
    ...
    @Autowired
    protected ObjectMapper objectMapper; // 직렬화, 역직렬하를 위한 클래스
    ...
    public void deleteArticle() throws Exception {
        ...
        Article savedArtilcle = blogRepository.save(Article.builder()
                .title(title)
                .content(content)
                .build());

        // when
        mockMvc.perform(delete(url, savedArtilcle.getId()))
                .andExpect(status().isOk());
